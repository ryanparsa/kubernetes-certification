...
Create the script `cka/22/lab/find_pods.sh`:

```bash
# cka/22/lab/find_pods.sh
...
For the second command we create the script `cka/22/lab/find_pods_uid.sh`:

```bash
# cka/22/lab/find_pods_uid.sh
...
```bash
sh cka/22/lab/find_pods_uid.sh
```
...
- [ ] File /opt/lab/5/find_pods.sh valid
- [ ] File /opt/lab/5/find_pods_uid.sh valid
