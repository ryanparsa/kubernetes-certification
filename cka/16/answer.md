...
kubectl -n kube-system get cm coredns -oyaml > cka/16/lab/coredns_backup.yaml
```
...
```bash
kubectl diff -f cka/16/lab/coredns_backup.yaml
...
kubectl -n kube-system delete -f cka/16/lab/coredns_backup.yaml
configmap "coredns" deleted

kubectl -n kube-system apply -f cka/16/lab/coredns_backup.yaml
