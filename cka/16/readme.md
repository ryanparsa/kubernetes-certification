...
k -n kube-system get cm coredns -oyaml > cka/16/course/coredns_backup.yaml
```
...
```bash
k diff -f cka/16/course/coredns_backup.yaml
...
k delete -f cka/16/course/coredns_backup.yaml
configmap "coredns" deleted

k apply -f cka/16/course/coredns_backup.yaml
