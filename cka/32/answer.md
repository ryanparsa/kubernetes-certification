...
```bash
vim cka/32/lab/cluster_events.sh
```

```bash
# cka/32/lab/cluster_events.sh
...
```bash
sh cka/32/lab/cluster_events.sh
...
Write the events caused by the deletion into `cka/32/lab/pod_kill.log`:

```bash
# cka/32/lab/pod_kill.log
...
Write the events caused by the killing into `cka/32/lab/container_kill.log`:

```bash
# cka/32/lab/container_kill.log
...
- [ ] File `cka/32/lab/cluster_events.sh` valid
- [ ] File `cka/32/lab/pod_kill.log` contains correct logs
- [ ] File `cka/32/lab/container_kill.log` contains correct logs
