...
```yaml
# cka/5/lab/api-gateway/staging/kustomization.yaml
...
```yaml
# cka/5/lab/api-gateway/base/api-gateway.yaml
...
```yaml
# cka/5/lab/api-gateway/prod/api-gateway.yaml
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: api-gateway
