...
```bash
kubectl -n kube-system exec etcd-cka-lab-control-plane -- etcd --version > cka/24/lab/etcd-version
```
...
> Inside the node, `cka/24/lab/` on your host is mounted at `/opt/lab/7/`.

First we try to create a snapshot of etcd:

```bash
ETCDCTL_API=3 etcdctl snapshot save /opt/lab/7/etcd-snapshot.db
```

```
{"level":"info","ts":"2024-11-07T14:02:17.746254Z","caller":"snapshot/v3_snapshot.go:65","msg":"created temporary db file","path":"/opt/lab/7/etcd-snapshot.db.part"}
^C
```
...
```
{"level":"info","ts":"2025-03-02T13:35:48.806437Z","caller":"snapshot/v3_snapshot.go:65","msg":"created temporary db file","path":"/opt/lab/7/etcd-snapshot.db.part"}
...
{"level":"info","ts":"2025-03-02T13:35:49.155886Z","caller":"snapshot/v3_snapshot.go:97","msg":"saved","path":"/opt/lab/7/etcd-snapshot.db"}
Snapshot saved at /opt/lab/7/etcd-snapshot.db
```
...
```bash
etcdutl snapshot restore /opt/lab/7/etcd-snapshot.db --data-dir /var/lib/etcd-snapshot
```

```
2025-03-02T13:38:07Z    info    snapshot/v3_snapshot.go:265     restoring snapshot      {"path": "/opt/lab/7/etcd-snapshot.db", "wal-dir": "/var/lib/etcd-snapshot/member/wal", "data-dir": "/var/lib/etcd-snapshot", "snap-dir": "/var/lib/etcd-snapshot/member/snap", "initial-memory-map-size": 0}
...
2025-03-02T13:38:08Z    info    snapshot/v3_snapshot.go:293     restored snapshot       {"path": "/opt/lab/7/etcd-snapshot.db", "wal-dir": "/var/lib/etcd-snapshot/member/wal", "data-dir": "/var/lib/etcd-snapshot", "snap-dir": "/var/lib/etcd-snapshot/member/snap", "initial-memory-map-size": 0}
```
