...
```bash
kubectl kustomize cka/34/lab/operator/base
...
```bash
kubectl kustomize cka/34/lab/operator/prod
apiVersion: apiextensions.k8s.io/v1
kind: CustomResourceDefinition
metadata:
  name: classes.education.killer.sh
...
```bash
vim cka/34/lab/operator/base/rbac.yaml
```

```yaml
# cka/34/lab/operator/base/rbac.yaml
apiVersion: rbac.authorization.k8s.io/v1
kind: Role
metadata:
  name: operator-role
...
```bash
vim cka/34/lab/operator/base/students.yaml
```

```yaml
# cka/34/lab/operator/base/students.yaml
...
