...
mkdir -p /opt/course/89

# Write the command
echo "kubectl expose pod pod1 --name=pod1-svc --type=NodePort --port=80" > /opt/course/89/pod1-svc.sh
```
...
- [ ] Command written to `/opt/course/89/pod1-svc.sh`
