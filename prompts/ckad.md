...
If you need to search each time for a sample or more info, you can search in `ref/` and `ckad/`. Use the `search-reference-material` and `search-k8s-docs` skills to find what you need.
