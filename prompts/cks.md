...
If you need to search each time for a sample or more info, you can search in `/Users/ryan/Projects/kubernetes-certification/ref` and `/Users/ryan/Projects/kubernetes-certification/cks`. Use the `grep -i -A10` command to find what you need.
