...
[`bat`](https://github.com/sharkdp/bat) and [`glow`](https://github.com/charmbracelet/glow) are useful for reading markdown in the terminal:

```bash
brew install bat glow

bat README.md          # syntax-highlighted, shows raw markdown
glow README.md         # renders markdown as formatted prose
glow -p answer.md      # pager mode (scroll with arrows, q to quit)
```
